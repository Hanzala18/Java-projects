public class EmployeePerformance {
    ...
    EmployeePerformance(String employeeName, String designation, int salary, String promotion_status, int taskCompleted,
            int projectCompleted, int employeeSupervision) {
